  ...
  return (
    <header className="bg-gradient-to-r from-emerald-600 via-emerald-500 to-teal-500 py-8 px-4 shadow-lg">
      <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-6">
        <div className="w-40 h-40 sm:w-48 sm:h-48 bg-white rounded-3xl p-3 shadow-2xl relative overflow-hidden transition-all duration-300 hover:shadow-3xl hover:scale-105" style={{ border: '2px solid rgba(16, 185, 129, 0.3)' }}>
